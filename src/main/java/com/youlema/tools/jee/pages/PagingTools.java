 ...
 *   PagingTools pt = new PagingTools();        // 或 new PagingTools(itemsPerPage);
 * 
 ...
 * 
 * @author liyd
 * @version $Id: PagingTools.java, v 0.1 2012-4-19 上午9:38:48 selfly Exp $
 */
public class PagingTools implements Serializable {
    ...
    //     */
    //    public PagingTools(int itemsPerPage) {
    ...
    //     * @param items 总项数
    //     */
    //    public PagingTools(int itemsPerPage, int items) {
    ...
    public int setItemsPerPage(int itemsPerPage) {
        ...
        if (page > 0) {
            setPage((int) (((double) (page - 1) * this.itemsPerPage) / this.itemsPerPage) + 1);
        }
